...
<div class="db-container" style="margin: 10% 0;">
      ...
      <h1 align="center"><img src="img/icones/gato.png" style="transform: scaleX(-1); width: 50px;"/> <?php echo $title?> <img src="img/icones/gato.png" style="width: 50px;"/></h1>
      <div class="search-box">
         <form id="buscarGatos" method="get" action="">
            <input name="to" type="hidden" value="gatos" />
      ...
      <?php else:?>
      <a href="?to=gatos&page=1"><button class="btn-filter">Limpar</button></a><br><br>
      <?php endif?>
      <form id="filterForm" method="get" action="">
         <div id="filter" class="filterdb">
            ...
            <div class="radio-item">
               ...
               <input id="<?php echo $tamanho; ?>" type="radio" name="filter" value="<?php echo$tamanho; ?>"onclick="submitFormFilter(this)" <?php echo isset($_GET['filter']) && $_GET['filter'] == $tamanho ? 'checked' : ''; ?>>
               <?php else: ?>
               <input id="<?php echo $tamanho; ?>" type="radio" name="filter" value="<?php echo$tamanho; ?>"onclick="submitFormFilter(this)">
               <?php endif ?>
               <label for="<?php echo $tamanho; ?>" style="color:white;"><img src="img/icones/<?php echo ($tamanho == 'Médio') ? 'medio' :strtolower($tamanho); ?>.png" /> <?php echo $tamanho; ?></label>
            </div>
...
<table class="lista-pets">
    ...
    foreach ($paginated_cats as $gato):
        if ($count % 3 == 0): 
            if ($count > 0) echo '</tr>'; 
            echo '<tr>';
        endif;
    ?>
        <td>
            <img src="<?php echo $gato['imagem'] ?>" alt="gato"><br><br>
            <p>Nome: <?php echo $gato['nome'] ?></p>
            <p>Raça: <?php echo $gato['raca'] ?></p>
            <p>Tamanho: <?php echo $gato['tamanho'] ?></p>
            <p>Peso: <?php echo $gato['peso'] ?></p>
            <p>Idade: <?php echo $gato['idade'] ?> Anos</p>
            <p>Doença: <?php echo ($gato['doenca'] == 1) ?'Sim' : 'Não' ?> </p>
            <div>
               <a href="?to=vergato&id=<?php echo $gato['id'] ?>" class="primary-btn">Ver</a>
            </div>
        </td>
    <?php
        $count++;
    ...
    ?>
      ...
      <?php else:?>
         <div class="pet-not-found">
            ...
            <img src="img/gatos/notfound.png">
             <?php if(isset($_GET['busca']) || isset($_GET['filter'])):?>
            <p><a href="?to=gatos" class="primary-btn"> Voltar a Pagina Anterior.</a></p>
             <?php else:?>
